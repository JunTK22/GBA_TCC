...
hex_file3 = "interrupt_test"

#with open("instrucoes.hex", "r") as f:
with open(hex_file3+".hex", "r") as f:
    words = f.read().split()
...
with open(hex_file3+".mif", "w") as f:
...
print(f"Conversion complete! {TARGET_DEPTH} entries written to "+hex_file3+".mif.")